...
export default function ResetPassword({ handleLogin, loggedIn }) {
  ...
  const checkPassword = (formRefCurrent, setEqual) => {
    const isEqual =
      formRefCurrent.password1.value === formRefCurrent.password2.value;
    setEqual(isEqual);
  };
  ...
  return (
    <div>
      ...
      {page === 'email' && (
        <MainContainer>
          <form ref={formRef} onSubmit={(e) => onClickEmail(e, formRef)}>
      ...
      {page === 'code' && (
        <MainContainer>
          <form ref={formRef} onSubmit={(e) => onClickCode(e, formRef)}>
            <Boxtitle>
              Please type in the 6-Digit Code you recieved by E-Mail.
            </Boxtitle>
            <InputField>
              <input
                type="text"
      ...
      {page === 'newpassword' && (
        <MainContainer>
          <form ref={formRef} onSubmit={(e) => onClickNewPassword(e, formRef)}>
